...
if __name__ == '__main__': 
    ...
    # # print(sample_image)
    # # sample_image = sample_image.permute(1, 2, 0)  # Convert from tensor to image format
    ...
    # # Iterate over the dataset and print some sample data
    ...
    # # Iterate over the dataloader and print some sample batches
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch % 20 == 0) or (epoch == num_epochs-1):
            with torch.no_grad():
                fake = netG(fixed_noise).detach().cpu()
                vutils.save_image(fake[0], f"output_256/single/generated_images_{epoch}.png", normalize=True)
